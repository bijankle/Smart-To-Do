...
const RAW: RawConcept[] = [
  {
    name: "groceries",
    aliases:
      "groceries grocery grocer food supermarket shopping coles woolworths woolies aldi iga costco kroger safeway tesco lidl",
    vocabulary:
  ...
  },
  {
    ...
    vocabulary:
      "shirt tshirt tee top pants jeans chino shorts trackie trackies tracksuit jacket puffer hoodie sweater jumper coat sock jocks undies underwear boxer brief bra dress skirt suit tie belt scarf glove beanie hat cap pyjama legging singlet thermal blazer cardigan trouser polo swimsuit swimmer trunks activewear uniform vest denim flannel linen raincoat bikini blouse camisole fleece gown robe lingerie nightie nightwear tights sweatshirt slacks poncho shawl pashmina sarong waistcoat overalls dungaree cufflink knickers stocking swim swimming hoody sunglasses sunnies corset kaftan romper nightgown swimwear underpants undershirt underclothes cargo tankini kilt necktie bonds champion adidas nike puma levis levi chinos joggers trackpants windbreaker parka anorak turtleneck jumpsuit tunic kimono balaclava mittens peacoat trench gilet henley bralette bodysuit onesie playsuit shrug bowtie earmuffs compression rashie boardshorts wetsuit windcheater skivvy crewneck crew vneck scoop seamless",
  },
  {
    // Footwear is its own bucket, so shoe words live here (moved out of
    // clothing) rather than doubling into the apparel stores.
    name: "footwear",
    aliases: "footwear shoes shoe",
    vocabulary:
      "footwear shoe shoes sneaker sneakers runner runners running boot boots sandal sandals thong thongs slipper slippers heel heels loafer loafers trainer trainers brogue brogues oxford oxfords moccasin moccasins espadrille espadrilles flipflop flipflops plimsoll sandshoe sandshoes cleat cleats stiletto stilettos crocs ugg uggs asics converse birkenstock",
  },
  {
    name: "outdoor",
